  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start gap-y-1 w-full min-w-0">
        {location && (
          <div className="flex items-center text-editorial-gray dark:text-white text-[10px] md:text-[11px] font-bold uppercase tracking-luxury gap-1.5 w-full transition-colors duration-300">
