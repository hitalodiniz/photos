  ...
  const footer = (
    <div className="w-full">
      <button
        ...
        type="submit"
        disabled={loading}
        className="w-full bg-champagne hover:bg-white text-petroleum font-bold py-3.5 rounded-luxury transition-all flex items-center justify-center gap-2 group uppercase tracking-luxury-widest text-[10px] shadow-lg shadow-champagne/10 disabled:opacity-50"
      >
        {loading ? (
              ...
              <>
                {galeria.leads_require_name && (
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-bold uppercase tracking-luxury-widest text-petroleum flex items-center gap-2">
