    ...
    >
      {!loading ? (
        <>
          ...
          <span className="tracking-tight text-[12px] md:text-base">Entrar com sua conta do Google</span>
        </>
      ) : (
        <div className="flex items-center gap-3">
          <div className="h-5 w-5 border-2 border-[#4285F4] border-t-transparent rounded-full animate-spin" />
          <span className="text-[#4285F4] font-medium">Conectando ao Google...</span>
        </div>
      )}
    </button>
  );
