...
export function LGPDPurposeField({
  register,
  setValue,
  watch,
  fieldName,
  ...
  return (
    <div className="space-y-1.5 animate-in fade-in duration-500">
      <div className="flex items-center gap-2">
        <label className="text-[10px] font-bold uppercase tracking-luxury-widest text-petroleum flex items-center gap-2 mb-0 font-sans">
        ...
        <div className="group relative flex items-center">
          ...
          <div className="absolute bottom-full left-0 mb-3 w-72 p-3 bg-slate-900 text-white text-[10px] font-medium leading-relaxed rounded-luxury opacity-0 pointer-events-none group-hover:opacity-100 transition-all duration-300 shadow-2xl z-[100] border border-white/10 font-sans">
            <p>
              Conforme a <strong className="text-gold">LGPD</strong>, você deve
              informar a finalidade específica do tratamento dos dados ao
              visitante.
            </p>
      ...
      >
        ...
        <option value="custom" className="font-bold">
          outra finalidade (digitar texto)...
        </option>
      </select>
