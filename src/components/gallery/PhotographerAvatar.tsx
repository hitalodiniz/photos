    ...
    <div className={`${positionClasses} flex flex-col items-center gap-1 animate-in fade-in duration-500`}>
      ...
      `}>
        <div className="flex flex-col items-center gap-1 mb-2">
          <p className="text-[10px] tracking-[0.1em] text-[#F3E5AB] font-bold opacity-80 uppercase">Fotografado por</p>
          <span className="text-lg font-serif italic text-white leading-tight">
            {galeria.photographer_name}
          </span>
        </div>

        {/* Mini Botões de Ação - Garantindo que sejam clicáveis */}
        <div className="flex items-center justify-center gap-3 relative z-10">
          {galeria.photographer_phone && (
            <a
              ...
              className="p-2 bg-white/10 text-white rounded-full hover:bg-[#25D366] transition-all border border-white/10 hover:scale-110 active:scale-95"
              onClick={(e) => e.stopPropagation()} // Evita fechar o lightbox se o clique propagar
            >
          ...
          {galeria.photographer_instagram && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 bg-white/10 text-white rounded-full hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#dc2743] hover:to-[#bc1888] transition-all border border-white/10 hover:scale-110"
          ...
          <a
            ...
            className="p-2 bg-white/10 text-white rounded-full hover:bg-[#D4AF37] transition-all border border-white/10 hover:scale-110"
            target="_blank"
            title="Perfil"
            onClick={(e) => e.stopPropagation()}
          >
