...
export default function PhotographerAvatar({ galeria, position, isVisible = true }: PhotographerAvatarProps) {
  ...
  return (
    <div className={`${positionClasses} flex items-center gap-3 animate-in fade-in duration-500`}>
      ...
      `}>
        ...
        <div className="relative group flex-shrink-0 cursor-pointer">
          ...
          <img
            ...
            className="relative w-12 h-12 md:w-16 md:h-16 rounded-full border-1 border-[#FFF9F0] object-cover shadow-xl transition-transform duration-500 group-hover:scale-105"
        ...
        <div className="flex flex-col items-start gap-2">
          ...
          <div className="flex items-center gap-2 relative z-10">
            ...
            <a
              ...
              onClick={(e) => e.stopPropagation()}
            >
              <svg width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" /></svg>
            </a>
          </div>
        </div>
      </div>
