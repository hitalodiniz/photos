            ...
            <div className="w-full md:w-auto flex justify-center md:justify-end pointer-events-auto z-[200]">
                ...
                >
                            ...
                            <div className="relative flex items-center border-r border-white/10 pr-3 ml-2">
                                <button onClick={toggleFavorite} className={`flex items-center gap-0 transition-all duration-500 group ${isFavorited ? 'text-[#E67E70]' : 'hover:text-[#F3E5AB]'}`}>
                            ...
                            <button onClick={handleDownload} className="flex items-center gap-0 transition-all duration-500 group border-r border-white/10 pr-3 ml-2">
                                <div className="flex items-center justify-center w-8 h-8 md:w-11 md:h-11 rounded-full bg-white/5 group-hover:bg-white/10 transition-colors shrink-0">
                                    {isDownloading ? <Loader2 className="animate-spin text-[#F3E5AB] w-[20px] h-[20px] md:w-[24px] md:h-[24px]" /> : <Download className="text-white w-[20px] h-[20px] md:w-[24px] md:h-[24px]" />}
                                </div>
                                <div className={`flex flex-col items-start leading-none transition-all duration-500 overflow-hidden ${showButtonText ? 'max-w-[100px] opacity-100 ml-2' : 'max-w-0 opacity-0 ml-0'}`}>
