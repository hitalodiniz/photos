...
export const PhotographerAvatar = ({ photoPreview, isExpanded }: any) => (
  <div
    className={`relative flex items-center justify-center border border-champagne/60 rounded-full bg-black/40 backdrop-blur-md transition-all duration-1000 
      shrink-0 shadow-2xl overflow-hidden aspect-square ${
