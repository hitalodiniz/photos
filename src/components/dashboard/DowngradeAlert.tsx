        ...
        {(trialExpired || total === 0) && (
          <div className="bg-rose-50 border border-rose-200 rounded-lg p-4">
            ...
            <p className="text-[12px] text-rose-700 leading-relaxed">
              Para manter os recursos do plano atual sem interrupcoes, assine um
              plano pago agora.
            </p>
          </div>
        )}
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[12px] text-amber-700 leading-relaxed">
                  ...
                  para a seção <strong>"Arquivadas"</strong> para se adequar ao
                  novo limite do plano.
                </p>
              </div>
            </div>
          ...
          <p className="text-[11px] text-blue-800 leading-relaxed">
            {total > 0 ? (
              <>
                ...
                publicas novamente, faca upgrade do seu plano ou desative outras
                galerias ativas primeiro. Acesse{' '}
                <strong>Menu → Arquivadas</strong> para gerencia-las.
              </>
            ) : (
              <>
                <strong>💡 Proximo passo:</strong> Assine um plano para manter
                os recursos avancados e evitar limitacoes apos o encerramento do
                trial.
              </>
            )}
          </p>
