  ...
  return (
    <button
      ...
      className={`flex items-center justify-center w-full max-w-sm mx-auto
        bg-white text-[#3C4043] font-medium border border-[#DADCE0] rounded-lg 
        shadow-sm hover:bg-[#F8F9FA] py-2 px-4 transition-all duration-150
    ...
    >
      {!loading ? (
        ...
        <div className="flex items-center gap-2">
          <div className="h-4 w-4 border-2 border-[#0B57D0] border-t-transparent rounded-full animate-spin" />
