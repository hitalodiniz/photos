  ...
  const notFoundItems = [
    {
      ...
      desc: (
        ...
        <div className="flex flex-col items-center gap-6 text-center">
          ...
          <button
            onClick={() => router.push('/')}
            className="w-fit px-8 py-3 bg-gold hover:bg-gold/90 text-black font-semibold uppercase tracking-widest text-[10px] rounded-full transition-all flex items-center gap-2 shadow-lg shadow-gold/10"
          >
        ...
        <main className="flex-grow flex flex-col items-center justify-center py-6 md:py-10">
          ...
          <div className="mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="flex items-center gap-3 px-5 py-2.5 bg-white/5 border border-white/10 rounded-full backdrop-blur-md">
              ...
              <p className="text-[10px] md:text-xs text-white/70 uppercase tracking-widest font-semibold">
                Redirecionando em{' '}
