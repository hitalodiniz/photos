'use client';
import { SearchX, Home, LogIn, Camera, Globe } from 'lucide-react';
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col overflow-hidden bg-[#000]">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        <EditorialHeader
          title="Erro 404"
          subtitle={<>Conteúdo não encontrado ou <span className="font-bold border-b-2 border-[#F3E5AB]/50 text-white">galeria indisponível</span></>}
        />

        <main className="flex-grow flex items-center justify-center py-10 px-4">
          <section className="w-full max-w-5xl mx-auto bg-white/95 backdrop-blur-xl 
