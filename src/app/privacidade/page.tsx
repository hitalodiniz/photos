'use client';
import { Camera, ArrowLeft, ShieldCheck, Database, Share2, Lock } from 'lucide-react';
    ...
    <div className="relative min-h-screen w-full flex flex-col overflow-hidden bg-[#000]">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <EditorialHeader
          ...
          subtitle={<>Compromisso com a <span className="font-bold border-b-2 border-[#F3E5AB]/50 text-white">segurança dos seus dados</span></>}
        />
