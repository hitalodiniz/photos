      ...
      <header className="relative md:absolute top-0 left-0 right-0 flex flex-col md:flex-row items-center justify-between p-6 md:px-14 md:py-8 text-white/90 z-[70] bg-gradient-to-b from-black/90 via-black/40 to-transparent w-full gap-6">
        ...
        >
          ...
          >
            ...
            <div
              className={`flex flex-col items-start gap-0.5 leading-none transition-all duration-500 overflow-hidden ${showButtonText ? 'max-w-[120px] opacity-100 ml-2 pr-3' : 'max-w-0 opacity-0 ml-0'}`}
            >
          ...
          >
            ...
            <div
              className={`flex flex-col items-start gap-0.5 leading-none transition-all duration-500 overflow-hidden ${showButtonText ? 'max-w-[120px] opacity-100 ml-2 pr-2' : 'max-w-0 opacity-0 ml-0'}`}
            >
