// tenho que repensar a FAQ, vou te enviar o codigo para ir atualizarmos a medida que vou te enviando os codigos das
// funcionalidades internas como Dashboard, Onboarding, Card da Galeria, criar e editar galeria,
// preferencias do usuário, configuração de mensagens, me ajude a organizar isso para ser fonte de consulta do usuário
